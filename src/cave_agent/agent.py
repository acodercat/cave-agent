...
class CaveAgent:
    ...
    Args:
        ...
        runtime: Python runtime with functions, variables, types, and skills.
    ...
    def build_system_prompt(self) -> str:
        ...
        instructions = self.system_instructions + self.runtime.skill_instructions
        if self.max_exec_timeout is not None:
            instructions += EXEC_TIMEOUT_INSTRUCTION.format(timeout=self.max_exec_timeout)
        ...
        return self.system_prompt_template.format(
            ...
            skills=self.runtime.describe_skills(),
